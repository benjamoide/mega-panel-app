...
# --- COMPONENTE RENDERIZAR DÍA (REUTILIZABLE) ---
def renderizar_dia(fecha_obj):
    ...
    # 3. CLASIFICAR
    ids_seleccionados_libre = db_usuario.get("meta_diaria", {}).get(fecha_str, []) if clave_usuario != "usuario_rutina" else []
